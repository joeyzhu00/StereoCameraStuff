...
namespace pc_processing_node
{
    ...
    sensor_msgs::PointCloud PcProcessingNode::count_points_in_box(sensor_msgs::PointCloud2& input_msg)
    {
        ...
        pcProcessingNode_nh.getParam("/segmentation/x_lower_bound", x_lower_bound);
        pcProcessingNode_nh.getParam("/segmentation/x_upper_bound", x_upper_bound);

        pcProcessingNode_nh.getParam("/segmentation/y_lower_bound", y_lower_bound);
        pcProcessingNode_nh.getParam("/segmentation/y_upper_bound", y_upper_bound);

        pcProcessingNode_nh.getParam("/segmentation/z_lower_bound", z_lower_bound);
        pcProcessingNode_nh.getParam("/segmentation/z_upper_bound", z_upper_bound);
        ...
        pcProcessingNode_nh.getParam("/segmentation/points_in_box_threshold", points_in_box_threshold);
    ...
    bool PcProcessingNode::cluster_size_filter(interface::Cluster_bound input_cluster_bound)
    {
        ...
        pcProcessingNode_nh.getParam("/segmentation/x_size_lim", x_size_lim);
        pcProcessingNode_nh.getParam("/segmentation/y_size_lim", y_size_lim);
        pcProcessingNode_nh.getParam("/segmentation/z_size_lim", z_size_lim);

        pcProcessingNode_nh.getParam("/segmentation/x_size_min", x_size_min);
        pcProcessingNode_nh.getParam("/segmentation/y_size_min", y_size_min);
        pcProcessingNode_nh.getParam("/segmentation/z_size_min", z_size_min);

        int bounds_passing_threshold;
        pcProcessingNode_nh.getParam("/segmentation/bounds_passing_threshold", bounds_passing_threshold);
    ...
    void PcProcessingNode::segmentation(sensor_msgs::PointCloud& points_in_box)
    {
        ...
        pcProcessingNode_nh.getParam("/segmentation/cluster_tolerance", cluster_tolerance);

        float min_cluster_size;
        pcProcessingNode_nh.getParam("/segmentation/min_cluster_size", min_cluster_size);

        float max_cluster_size;
        pcProcessingNode_nh.getParam("/segmentation/max_cluster_size", max_cluster_size);
...
int main(int argc, char** argv)
{
    ...
    pc_processing_node::PcProcessingNode segmentation;

    segmentation.initRosComm();
